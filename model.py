...
BS= 32
TS=(24,24)
train_batch= generator('D:\\Project\\dataset_new\\train',shuffle=True, batch_size=BS,target_size=TS)
valid_batch= generator('D:\\Project\\dataset_new\\valid',shuffle=True, batch_size=BS,target_size=TS)
